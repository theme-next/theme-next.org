...
{% tabs vkontakte_api %} <!-- tab Get API ID → --> Login to VKontakte Developers and 
...
{% code lang:yml next/_config.yml %} vkontakte_api: enable: false app_id: API_ID #<app_id> comments: true num_of_posts: 10 {% endcode %} <!-- endtab --> {% endtabs %}
...
{% tabs vkontakte_api_like %} <!-- tab Get API ID → --> Login to VKontakte Developers and 
...
{% code lang:yml next/_config.yml %} vkontakte_api: enable: false app_id: API_ID #<app_id> like: true num_of_posts: 10 {% endcode %} <!-- endtab --> {% endtabs %}
...
{% tabs rating %} <!-- tab Get ID → --> Login to 

[widgetpack](https://widgetpack.com/admin#signin) and add new site, you will get your site ID: {% code lang:html %} wpac_init.push({widget: 'Rating', id: ID}); {% endcode %} <!-- endtab -->
...
{% code lang:yml next/_config.yml %} rating: enable: false id: ID #<app_id> color: fc6423 {% endcode %} <!-- endtab --> {% endtabs %}