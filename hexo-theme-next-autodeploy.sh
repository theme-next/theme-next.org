...
echo "${yellow}jquery-lazyload:${norm} ${lcyan}`git -C themes/next/source/lib/fancybox pull || git clone https://github.com/theme-next/theme-next-fancybox3 themes/next/source/lib/fancybox`${norm}"
